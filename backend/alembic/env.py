...
from backend.core.models import button, device, account, protocol
...
async_engine = create_async_engine(settings.get("DATABASE_URL"), poolclass=pool.NullPool)
...
def run_migrations_online() -> None:
    ...
    """
    connectable = create_engine(settings.get("DATABASE_URL").replace("asyncpg", "psycopg2"))
